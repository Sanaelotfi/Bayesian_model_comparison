...
parser.add_argument('--chk_path', default="checkpoint/cifar100/optimized_la", type=str, help='path to save the checkpoints')
parser.add_argument('--result_folder', default='./results/cifar100/optimized_la/', type=str, help='path to save the results')
...
def train_model(arch,
    ...
    if optimizehypers:
        path = "cifar100_" + str(prior_prec_init) + '_' + arch + '_' + str(width) + '_' + prior_structure + '_' + hessian_structure + '_hlr' + str(hypers_lr)
    else:
        path = "cifar100_" + str(prior_prec_init) + '_' + arch + '_' + str(width) + '_' + prior_structure
    if batchnorm:
