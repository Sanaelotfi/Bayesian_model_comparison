...
parser.add_argument('--partialtrain_chk_path', default="checkpoint/cifar10/subset/cnns" , type=str, help='path for the checkpoint for this model')
parser.add_argument('--fulltrain_chk_path', default="checkpoint/cifar10/new_hypers/cnns" , type=str, help='path for the checkpoint for this model')
parser.add_argument('--result_folder', default='./results/cifar10/subset/cnns/cmll/', type=str, help='path of the results')
...
def get_mll_acc(width,
    ...
    fullpath = "cifar10_" + str(prior_prec_init) + '_fixup_cnn' + str(depth) + '_' + str(width) + '_' + prior_structure
    ...
    bma_test_accuracy, bma_test_probs, all_test_ys = get_bma_acc(net, la,
                                                                 testloader,
                                                                 bma_nsamples,
                                                                 hessian_structure,
                                                                 temp=best_temp)
