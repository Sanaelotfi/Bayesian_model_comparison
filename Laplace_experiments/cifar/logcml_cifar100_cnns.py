...
parser.add_argument('--partialtrain_chk_path', default="checkpoint/cifar100/subset/cnns" , type=str, help='path for the checkpoint for the model trained on a fraction of the data')
parser.add_argument('--fulltrain_chk_path', default="checkpoint/cifar100/new_hypers/cnns" , type=str, help='path for the checkpoint for the model trained on the full data')
parser.add_argument('--result_folder', default='./results/cifar100/subset/cnns/cmll/', type=str, help='path of the results')
...
def get_mll_acc(width,
    ...
    fullpath = "cifar100_" + str(prior_prec_init) + '_fixup_cnn' + str(depth) + '_' + str(width) + '_' + prior_structure
